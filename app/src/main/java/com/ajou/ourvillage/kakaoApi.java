...
public class kakaoApi extends Application {
    private static volatile kakaoApi instance = null;
        ...
        public IApplicationConfig getApplicationConfig() {
            return new IApplicationConfig() {
                ...
                public Context getApplicationContext() {
                    return kakaoApi.getGlobalApplicationContext();
                }
            };
        }
    }

    public static kakaoApi getGlobalApplicationContext() {
        if(instance == null) {
            throw new IllegalStateException("this application does not inherit com.kakao.kakaoApi");
        }
        return instance;
    }
